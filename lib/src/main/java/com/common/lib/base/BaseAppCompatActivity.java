...
import com.common.lib.helper.VaryViewHelperController;
import com.common.lib.network.ConnectionObserver;
import com.common.lib.network.NetworkStateReceiver;
import com.common.lib.network.NetworkUtils;
...
public abstract class BaseAppCompatActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isSwipeBackHere()){
            getSwipeBackLayout().setEnableGesture(true);//打开右滑返回上一级
        }
